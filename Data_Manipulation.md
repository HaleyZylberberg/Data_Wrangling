...
Select is used to select columns. Can change order with this. The “:”
means everything between variables.
...
Starts with includes all variables that start with certain letters, can
also do ends with and contains.
...
```
    ...
    ##    group   litter_number gd18_weight gd_of_birth
    ## 1   Con7             #85        34.7          20
    ## 2   Con7       #1/2/95/2        42.0          19
    ## 3   Con7   #5/5/3/83/3-3        41.4          19
    ## 4   Con7     #5/4/2/95/2        44.1          19
    ## 5   Con7     #4/2/95/3-3          NA          20
    ## 6   Con7     #2/2/95/3-2          NA          20
    ## 7   Con7 #1/5/3/83/3-3/2          NA          20
    ## 8   Con8       #3/83/3-3          NA          20
    ## 9   Con8         #2/95/3          NA          20
    ## 10  Con8     #3/5/2/2/95          NA          20
    ## 11  Con8     #5/4/3/83/3          NA          19
    ## 12  Con8   #1/6/2/2/95-2          NA          20
    ## 13  Con8 #3/5/3/83/3-3-2          NA          20
    ## 14  Con8       #2/2/95/2          NA          19
    ## 15  Con8   #3/6/2/2/95-3          NA          20
    ## 16  Mod7             #59        33.4          19
    ## 17  Mod7            #103        42.1          19
    ## 18  Mod7       #1/82/3-2          NA          19
    ## 19  Mod7       #3/83/3-2          NA          19
    ## 20  Mod7       #2/95/2-2          NA          20
    ## 21  Mod7       #3/82/3-2        45.9          20
    ## 22  Mod7       #4/2/95/2          NA          19
    ## 23  Mod7     #5/3/83/5-2        37.0          19
    ## 24  Mod7      #8/110/3-2          NA          20
    ## 25  Mod7            #106        37.8          20
    ## 26  Mod7           #94/2        42.9          19
    ## 27  Mod7             #62        35.9          19
    ## 28  Low7           #84/2        40.8          20
    ## 29  Low7            #107        42.4          20
    ## 30  Low7           #85/2        38.5          20
    ## 31  Low7             #98        43.8          20
    ## 32  Low7            #102        43.3          20
    ## 33  Low7            #101        42.7          20
    ## 34  Low7            #111        44.6          20
    ## 35  Low7            #112        40.5          19
    ## 36  Mod8             #97        42.8          20
    ## 37  Mod8           #5/93        41.1          20
    ## 38  Mod8         #5/93/2          NA          19
    ## 39  Mod8       #7/82-3-2        43.2          20
    ## 40  Mod8      #7/110/3-2        46.0          19
    ## 41  Mod8         #2/95/2        44.5          20
    ## 42  Mod8           #82/4        52.7          20
    ## 43  Low8             #53        37.2          20
    ## 44  Low8             #79        43.8          19
    ## 45  Low8            #100        39.2          20
    ## 46  Low8           #4/84        35.2          20
    ## 47  Low8            #108        47.5          20
    ## 48  Low8             #99        39.0          20
    ## 49  Low8            #110        42.7          20

Can also rename during select. But can rename without select and keep
everything.
...
select vs pull. Select keeps the dataframe and pull creates a vector
(gets something out of data frame.
...
```
    ...
    ## # A tibble: 31 × 6
    ##    group litter_number gd0_weight gd18_weight gd_of_birth weight_gain
